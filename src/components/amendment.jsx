        ...
        <ul>
          {props.list.map(question => (
            <li key={question.name}>
              ...
              <button onClick={() => props.onRemoveQuestion(question.name)}>
                Remove
              </button>
              <button onClick={() => props.onToggleQuestion(question.name)}>
                Deactivate
              </button>
            </li>
          ))}
  ...
  render() {
    ...
    return (
      <div className="container">
        ...
        />
        <button onClick={this.handleAddQuestion}>Submit</button>
        <div>
          <button
            onClick={() =>
              this.setState({
        ...
        <ActiveQuestions
          list={this.state.questions.filter(
